...
// El plano de lotes dejó de ser una imagen: ahora es img/mapa.svg, geometría
// sacada del CAD del arquitecto y pintada desde data/lotes.json. Se fue con él
// la prueba «el plano está al día con el inventario», que comparaba una huella
// (img/mapa-estado.json) contra los estados reales. Esa guarda existía porque
// los colores vivían quemados dentro del JPG y podían quedarse atrás. Ya no
// hay dos versiones del dato que puedan separarse. Lo que ahora se comprueba
// —que cada polígono encierre el área que declara el inventario— está en
// test/mapa.test.js.
